# #97 ♻️ F2: split the two API clients by contract, and fix what that exposed

**State:** closed 2026-08-02 · **Branch:** `f2-closed-models` into `main` · **Diff:** +24 / -0 across 1 files · **Opened:** 2026-08-02
...
**The grep measurement was wrong in both directions.** The one-liner I recommended last session:
...
### onhazrat on 2026-08-02

Opened against a stale branch: `f2-closed-models` still held the merged docs-only commit from #95, so this PR shows that instead of the F2 work. Superseded by a fresh branch.
