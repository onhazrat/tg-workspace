...
export function BotAvatar({ bot, className = "w-10 h-10" }: { bot: BotCredential; className?: string }) {
  ...
  return (
    <div className={`${className} rounded-full bg-app-ink/5 border border-app-ink/10 flex items-center justify-center`}>
